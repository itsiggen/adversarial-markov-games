...
def objective(trial):
    ...
    print("Saving models...")
    interceptor.save("mods/games/bags4int_" + str(trial.number) + ".pt")
    adversary.save("mods/games/bags4adv.pt")
    ...
    interceptor = RPPO.load("mods/games/bags4int_" + str(trial.number) + ".pt" , envv, "interceptor", seed)
