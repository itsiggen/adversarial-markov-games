...
# env = gym.make("HsjaSkip-v0", steps=5000, rewarder=1)#, nonadaptive=True)
...
model = PPO.load('mods/hsjaskip_best4.pt')

# Evaluate the agent
envv = gym.make("HsjaSkip-v0", steps=5000, train=False, nonadaptive=True)
# random.seed(7)
