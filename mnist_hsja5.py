...
def test(num, rew):
    ...
    interceptor = RPPO.load("mods/games/hsja4int_11.pt", envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/hsja5adv_" + str(num) + ".pt", envv, "adversary", seed)
    ...
    c = np.mean(a)
    d = np.mean(b)
    print(f'hsja5 | defended {defended}:', res, c, d)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default=str("14"), type=str, help="Agent to load")
