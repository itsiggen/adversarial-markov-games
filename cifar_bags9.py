...
def objective(trial):
    ...
    print("Saving models...")
    adversary.save("mods/games/cbags9Vadv_" + str(trial.number) + ".pt")
    ...
    adversary = RPPO.load("mods/games/cbags9Vadv_" + str(trial.number) + ".pt" , envv, "adversary", seed)
...
def test(num, rew):
    ...
    interceptor = RPPO.load("mods/games/cbags4int_2.pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/cbags9Vadv_" + str(num) + ".pt", envv, "adversary", seed)
