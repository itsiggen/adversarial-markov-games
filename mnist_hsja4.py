...
def objective(trial):
    ...
    print("Saving models...")
    interceptor.save("mods/games/hsjaa4int_" + str(trial.number) + ".pt")
    adversary.save("mods/games/hsjaa4adv.pt")
    ...
    interceptor = RPPO.load("mods/games/hsjaa4int_" + str(trial.number) + ".pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/hsjaa4adv.pt", envv, "adversary", seed)
...
def test(num, rew):
    ...
    interceptor = RPPO.load("mods/games/hsja4int_" + str(num) + ".pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/hsja4adv.pt", envv, "adversary", seed)
    ...
    c = np.mean(a)
    d = np.mean(b)
    print(f'hsja4 | defended {defended}:', res, c, d)
