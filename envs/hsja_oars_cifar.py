...
class HsjaOARSCIFAR(gym.Env):
    def __init__(
        ...
        super(HsjaOARSCIFAR, self).__init__()
    ...
    def reset(self):
        ...
        # Variance estimation goes first
    ...
    def step_adv(self, action):
        ...
        # ...except of delta that is adapted OARS
   ...
   # Decompose steps
    ...
    def binary_query(self):
        ...
        return self.logits, self.btrans
    ...
    def binary_proceed(self):
        ...
        self.bsteps += 1
        # binary alignment
        self.blign.append(1) if self.is_adv == self.is_bog else self.blign.append(-1)
    ...
    def jump_query(self):
        ...
        self.jsteps += 1
        self.iter += 1
        return self.logits, self.jtrans
