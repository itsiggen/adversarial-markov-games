...
def objective(trial):
    ...
    print('Training CBAGS-7: AA-AD..')
    
    eval_steps = 5000
    adaptive = 3 # both adaptive 
    stt = 2 # interceptor is learning
    ratio = 0.5
    defended = False
    cont = 2
    seed = 2
    ...
    print("Saving models...")
    interceptor.save("mods/games/cbags7int_" + str(trial.number) + ".pt")
    adversary.save("mods/games/cbags7adv_" + str(trial.number) + ".pt")
    ...
    interceptor = RPPO.load("mods/games/cbags7int_" + str(trial.number) + ".pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/cbags7adv_" + str(trial.number) + ".pt" , envv, "adversary", seed)
...
def test(num, r1, r2, scale):
    ...
    interceptor = RPPO.load("mods/games/cbags7int_" + str(num) + ".pt", envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/cbags7adv_" + str(num) + ".pt" , envv, "adversary", seed)
