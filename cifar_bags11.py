...
def objective(trial):
    ...
    print("Saving models...")
    interceptor.save("mods/games/cbags11int_" + str(trial.number) + ".pt")
    adversary.save("mods/games/cbags11adv_" + str(trial.number) + ".pt")
    ...
    interceptor = RPPO.load("mods/games/cbags11int_" + str(trial.number) + ".pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/cbags11adv_" + str(trial.number) + ".pt" , envv, "adversary", seed)
...
def test(num, r1, r2):
    ...
    interceptor = RPPO.load("mods/games/cbags11int_" + str(num) + ".pt", envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/cbags11adv_" + str(num) + ".pt" , envv, "adversary", seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default=str("20"), type=str, help="Agent to load")
    parser.add_argument('--r1', default=int(3), type=bool, help="Int reward used")
    parser.add_argument('--r2', default=int(4), type=bool, help="Adv reward used")
