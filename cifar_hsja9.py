...
def objective(trial):
    ...
    print('Training CHSJA-9: AA-TD..')
    
    eval_steps = 5000
    defense = 0 # 0 vanilla | 1 trained | 2 adaptive 
    ...
    print("Saving models...")
    adversary.save("mods/games/chsja9Vadv_" + str(trial.number) + ".pt")
    ...
    adversary = RPPO.load("mods/games/chsja9Vadv_" + str(trial.number) + ".pt", envv, "adversary", seed)
...
def test(num, rew):
    ...
    interceptor = RPPO.load("mods/games/chsja4int_5.pt" , envv, "interceptor", seed)
    adversary = RPPO.load("mods/games/chsja9Vadv_" + str(num) + ".pt", envv, "adversary", seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default=str("20"), type=str, help="Model to load")
